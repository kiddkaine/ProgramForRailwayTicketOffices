...
namespace Program
{
    public partial class Form9_Add : Form
    {
        ...
        private void Form9_Add_Load(object sender, EventArgs e)
        {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {
                string sql_update_current_client = $"INSERT INTO clients (fio_client, pass_client, id_privilege) " +
